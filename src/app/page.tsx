...
const faqs = [
  ...
  {
    question:
      "Apakah Attendify bisa terintegrasi dengan sistem yang sudah ada?",
    answer:
...
export default function Home() {
  return (
    <div className="overflow-x-hidden">
      <div
        className="grid grid-cols-1 md:grid-cols-2 md:gap-8 items-center min-h-screen justify-center container"
        data-aos="zoom-out"
      >
        ...
        <div className="text-center md:text-left">
          ...
          <p>
            Lacak kehadiran menjadi lebih mudah! Cukup dengan sekali tap
            kehadiran langsung tercatat dengan cepat dan akurat.
          </p>
          <div className="flex justify-center md:justify-start gap-4 mt-4">
            <Link
              href={
                "https://www.instagram.com/reel/DCqc0W6y-hv/?utm_source=ig_web_copy_link"
              }
              target="_blank"
            >
        ...
        <div className="container flex flex-col gap-28">
          <div className="flex flex-col gap-7">
            ...
            <p className="max-w-xl text-lg" data-aos="fade-up">
              Attendify mempermudah pengelolaan presensi secara cepat dan
              otomatis. Dengan teknologi berbasis RFID, anda dapat melacak
              kehadiran secara cepat, aman, dan efisien hanya dalam hitungan
              detik, menghemat waktu sekaligus mengurangi kesalahan manual.
            </p>
          </div>
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              ...
              <p className="text-lg font-medium">
                Kami percaya bahwa pencatatan kehadiran harus mudah dan dapat
                diandalkan. Misi kami adalah memberdayakan organisasi dengan
                alat cerdas yang menghilangkan pekerjaan administratif,
                meningkatkan akuntabilitas, dan menciptakan pengalaman yang
          ...
          <div className="flex flex-col gap-6 md:gap-20">
            <div className="max-w-xl">
              ...
              <p className="text-muted-foreground" data-aos="fade-up">
                Kami membantu membuat proses presensi sepenuhnya otomatis dan
                efisien. Berikut langkah-langkah yang kami lakukan untuk
                mencapainya.
              </p>
            </div>
            <div className="grid gap-10 md:grid-cols-3" data-aos="fade-up">
              <div className="flex flex-col">
                ...
                <p className="text-muted-foreground">
                  Tidak perlu lagi mencatat secara manual. Cukup pindai kartu
                  RFID, dan kehadiran tercatat secara real-time.
                </p>
              </div>
              <div className="flex flex-col">
                <div className="mb-5 flex size-12 items-center justify-center rounded-2xl bg-accent">
                ...
                <p className="text-muted-foreground">
                  Cocok untuk berbagai kebutuhan, sistem kami mudah disesuaikan
                  tanpa kesulitan.
                </p>
              </div>
              <div className="flex flex-col">
                ...
                <p className="text-muted-foreground">
                  Dapatkan wawasan kehadiran secara real-time, sehingga Anda
                  bisa lebih fokus pada hal yang penting.
                </p>
              </div>
            </div>
            <div className="grid gap-10 md:grid-cols-2">
              <div>
                ...
                <p className="text-muted-foreground" data-aos="fade-up">
                  Menyederhanakan sistem absensi Anda hanya dalam satu klik.
                  Kami hadir untuk mendukung inovasi dan memberikan solusi
                  pelacakan kehadiran yang cepat, akurat, dan andal.
                  Bergabunglah untuk menciptakan perubahan yang berarti!
                </p>
              </div>
              <div>
                <Image
        ...
        <div className="container">
          <div className="text-center" data-aos="fade-up">
            ...
            <p className="mt-6 font-medium text-muted-foreground max-w-xl mx-auto">
              Temukan semua detail penting tentang platform kami dan bagaimana
              platform tersebut dapat memenuhi kebutuhan Anda.
            </p>
          </div>
